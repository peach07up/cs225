...
gradientColorPicker::gradientColorPicker( RGBAPixel fadeColor1, 
		RGBAPixel fadeColor2, int radius, int centerX, int centerY ) {	a=fadeColor1;
	b=fadeColor2;
	r=radius;
	cx=centerX;
	cy=centerY;
...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
	...
	if(d<r)
	{
	color.red = a.red-a.red*d/r+b.red*d/r;
	color.green = a.green-a.green*d/r+b.green*d/r;
	color.blue = a.blue-a.blue*d/r+b.blue*d/r;
	color.alpha = a.alpha-a.alpha*d/r+b.alpha*d/r;
	} else {
	return b;}
	/**
